<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="appointment.aspx.cs" Inherits="diagnostic.home" %>
        ...
        <div  class="col-lg-10 col-lg-offset-1 col-xs-12" style=" background-color:lightgray;opacity:0.7;margin-top:2%;">
            ...
            <div class="col-xs-11">
                ...
                <div class="col-lg-4">
                    ...
                    <asp:TextBox ID="txtage" runat="server" Class="form-control" placeholder="Patients Name" OnTextChanged="txtname_TextChanged" ReadOnly="True" ></asp:TextBox><br />
                           </div>
                <div class="col-lg-4">
            ...
            <div class="col-xs-11"> <br />
               <br /> <asp:Button ID="btnbook" runat="server" Text="Book Appointment" OnClick="btnbook_Click" style="margin-left:30%; color:mediumblue;" />
                <asp:Button ID="btncancel" runat="server" Text="Cancel" style="margin-left:40px; color:darkblue;" />
